...
describe("GA4", function () {
  ...
  describe("GA4.initialize()", function () {
    ...
    it("initialize() with default titleCase true", function () {
      // Given
      var options = {};
      ...
      expect(_gtag["default"]).toHaveBeenNthCalledWith(1, "js", newDate);
      expect(_gtag["default"]).toHaveBeenNthCalledWith(2, "config", GA_MEASUREMENT_ID);
      expect(_gtag["default"]).toHaveBeenNthCalledWith(3, "event", "Action_name", {
        "event_category": "Category_name",
        "event_label": "Label_name"
      });
    });
    it("initialize() with titleCase false", function () {
      // Given
      var options = {
        titleCase: false
      };
